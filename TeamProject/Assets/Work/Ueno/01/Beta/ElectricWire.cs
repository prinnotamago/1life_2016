...
public class ElectricWire : MonoBehaviour {
 private Player _player;
    ...
    private ParticleSystem Spon_SnowEffect()
    {
        ...
        snow.transform.position = transform.position + new Vector3(1.0f, 1.0f, 0.0f);
        return snow;
    }
    ...
    private GameObject Spone_ChangeAria()
    {
        ...
        aria.transform.parent = transform;
        aria.transform.position = transform.position + new Vector3(1.0f, -0.55f, -0.5f);
        return aria;
    }
