...
public class Pond : MonoBehaviour {
    ...
    void Start ()
    {
        ...
        objs[0] = GameObject.Find("Point3");
        objs[1] = GameObject.Find("Point4");
        objs[2] = GameObject.Find("Point2");
        objs[3] = GameObject.Find("Point1");
    ...
    void IsRenderMeshUpdate()
    {
        ...
        for (int i = 0; i < vertices.Length; ++i)
        {
            ...
            if (i % 2 == 0)
            {              
                vertices[i] = _pondWaterList[i].transform.position - transform.position;
            }
            else
            {
                vertices[i] = _pondWaterList[i].transform.position + offset - transform.position;
            }
